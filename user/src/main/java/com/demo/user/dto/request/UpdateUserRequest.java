...
public record UpdateUserRequest(
                ...
                @Email(message = "Invalid email format") @Size(max = 150) String email,

                @Pattern(regexp = "^[0-9]{10,13}$", message = "Phone number must contain only digits and must be between 10 and 13 characters") String phone,
